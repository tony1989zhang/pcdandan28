 ...
 */
public class CheckBoxTagViewGroup2 extends TagViewGroup<CheckBox, String> {

    public CheckBoxTagViewGroup2(Context context) {
        super(context);
    }

    public CheckBoxTagViewGroup2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    @Override
    public CheckBox getTagItemView(int position, String tag) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.tag_view_group_default_check_box2, null);
